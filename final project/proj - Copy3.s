...
ihandler_kb:
	...
	andi	r9, r9, 0xFF
	movui	r10, 0xE0
	beq		r9, r10, E0_is_read
	br		E0_not_read
E0_is_read:
	ldwio	r9, 0(r8)
	srli	r11, r9, 8
	beq		r11, r0, E0_is_read
	andi	r9, r9, 0xFF
	movui	r10, 0xF0
	beq		r9, r10, skip_break_code
	br		epilog
E0_not_read:
	movui	r10, 0xF0
	beq		r9, r10, skip_break_code
	movui	r10, 0x3A
	beq		r10, r9, change_mode_kb
	br		epilog

skip_break_code:
	ldwio	r9, 0(r8)
	srli	r11, r9, 8
	beq		r11, r0, skip_break_code
	br		epilog
...
change_mode_kb:
	...
	bne		r9, r0, dont_change_to_mode1

dont_change_to_mode1:
	mov		r10, r0
	movia	r8, HEX
...
ihandler_pushbt:
	...
	bne		r9, r0,	dont_change_to_mode1_push
	
dont_change_to_mode1_push:
...
# setup timer with interrupt
	...
	stwio	r9, 4(r8)
	stwio	r0, 0(r8)
	movui	r9, %lo(50000000)
	stwio	r9, 8(r8)
	movui	r9, %hi(50000000)
	stwio	r9, 12(r8)
	movui	r9, 0b0111
	stwio	r9, 4(r8)
